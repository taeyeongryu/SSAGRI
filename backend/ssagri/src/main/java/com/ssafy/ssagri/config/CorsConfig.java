...
public class CorsConfig {
    ...
    //허가 페이지 목록
    private List<String> allowedSite = List.of("http://localhost:3000", "http://localhost:8080", "http://localhost:5173","http://localhost:3354", "http://localhost:5000", "https://j9b209.p.ssafy.io/");
